...
var prismCshtml$2 = {};
var hasRequiredPrismCshtml;
function requirePrismCshtml() {
  if (hasRequiredPrismCshtml) return prismCshtml$2;
  hasRequiredPrismCshtml = 1;
  (function(Prism2) {
    var commentLike = /\/(?![/*])|\/\/.*[\r\n]|\/\*[^*]*(?:\*(?!\/)[^*]*)*\*\//.source;
  ...
  return prismCshtml$2;
}
var prismCshtmlExports = requirePrismCshtml();
const prismCshtml = /* @__PURE__ */ getDefaultExportFromCjs(prismCshtmlExports);
const prismCshtml$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: prismCshtml
}, [prismCshtmlExports]);
export {
...
//# sourceMappingURL=prism-cshtml-vn-4zdEm.js.map
