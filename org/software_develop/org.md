...
- 模块的静态分析方法、动态分析方法
- 模块的形式化验证方法、等价性检查
- 功能测试方法和注意事项：自动化测试、智能体操作测试、人工操作测试
- 故障树分析、失效模式与影响分析
...
在代码旁边要写文档，放在代码旁边，而不是文档的仓库里，以便于查询，实现代码到需求的双向可追溯。
...
要执行 正常范围测试、边界测试、鲁棒性测试、应力测试。
穷尽性分析、早期缺陷发现、高可信度保证、优化验证证据生成、代码规范检查、缺陷检测、安全漏洞扫描、代码质量评估。
编译报告分析、运行日志分析。
必须实际运行测试代码，获得运行数据。
...
流程管理员负责监督协作过程中的流程性问题。
这是一个动态的组织，经常会有人员的增减，也需要大量的沟通交流。流程管理需要监督人员之间的沟通和协作，尽可能优化流程，实现质量保证、效率提升的目标。
